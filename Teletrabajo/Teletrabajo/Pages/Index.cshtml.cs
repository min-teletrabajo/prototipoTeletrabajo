...
namespace Teletrabajo.Pages
{
    public class IndexModel : PageModel
    {
        ...
        {
            Representante = await representanteRepository.GetRepresentanteAsync("20388240558");
            //Verifico que el representante existe, esto se mejoraria con el servicio Afip
