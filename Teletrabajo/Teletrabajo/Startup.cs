...
namespace Teletrabajo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<CPAOptions>(Configuration.GetSection("CPA"));
            services.AddTransient<ICPAService, CPAService>();

            services.Configure<AFIPOptions>(Configuration.GetSection("AFIP"));
